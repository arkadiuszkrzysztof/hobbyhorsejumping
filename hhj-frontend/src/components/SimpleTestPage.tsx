...
const SimpleTestPage: React.FC<SimpleTestPageProps> = ({ onClose }) => {
                        ...
                        <Card>
                            <CardContent>
                                ...
                                <Typography
                                    ...
                                    gutterBottom
                                >
                                    Simulate common sensor scenarios - make sure
                                    to select a competitor first!
                                </Typography>
                                ...
                                <List dense>
                                    {testResults.length > 0 ? (
                                        testResults.map((result, index) => (
                                            <ListItem key={index}>
                                                <ListItemText
                                                    primary={`${result.success ? '✅' : '❌'} ${result.action} (${result.duration}ms)`}
                        ...
                        <Card>
                            <CardContent>
                                ...
                                >
                                    ...
                                    />
                                    <Chip
                                        label={`WebSocket: ${process.env.REACT_APP_API_WEBSOCKET_URL || 'ws://127.0.0.1:3003'}`}
                                        variant="outlined"
                                        size="small"
                                    />
                                </Box>
                                ...
                                <TextField
                                    ...
                                    fullWidth
                                    variant="outlined"
                                    placeholder="Server responses will appear here... Click a test button above to start!"
                                    InputProps={{
                                        readOnly: true,
                                        sx: {
